...
namespace ExciteOMeter
{
    public class OnlineLineGraph : MonoBehaviour
    {
        ...
        {
            // Here is where I have found where value for heart rate is getting passed through! 
            // Unfortunately, it is also the same place where RRinterveral is getting passed through, and I don't know from where
            // or how to replicate something like this
            AddNewValue(value);
            UpdateTexts();
        }
