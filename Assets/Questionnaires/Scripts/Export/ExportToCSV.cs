...
namespace VRQuestionnaireToolkit
{
    public class ExportToCSV : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            //Custom for interoception expmt:
            if (experimentData == null)
            {
                experimentData = FindObjectOfType<ExperimentData>();
            }
            if (!Directory.Exists($"AllParticipantData/Participant_{experimentData.participantID}"))
            {
                Directory.CreateDirectory($"AllParticipantData/Participant_{experimentData.participantID}"); // returns a DirectoryInfo object
            }
            _folderPath = $"AllParticipantData/Participant_{experimentData.participantID}/";
            Debug.Log(_folderPath);
            //TODO: at end of experiment, from parent folder, move 
        ...
        public void Save()
        {
            ...
            string _completeFileName = "questionnaireID_" + _questionnaireID + "_participantID_" + experimentData.participantID + "_condition_" + experimentData.modOrderString + "_" + FileName + "." + _fileType;
        ...
        StringBuilder GetConsolidatedContent(string filepath, string[][] newData)
        {
            ...
            string header = "Answer_Participant_" + experimentData.participantID + "_condition_" + experimentData.modOrderString; // header for this current participant
